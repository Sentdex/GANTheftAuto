# GameGAN fork with improvements
...
Currently, Cartpole, Vroom and GTA V are the only implemented data sources.
...
### Vroom
The dataset is generated by playing Vroom with integrated AI driver. The car is instructed to follow the road, but offset from teh center changes to collect different data kinds.
- Install dependencies
```
cd data/vroom
pip3 install - requirements.txt
...
### GTA V
We cannot include this data collector because of TOS of the GTA V
